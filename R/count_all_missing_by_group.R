...
#' levels of `group`, and the rest of the columns contain the number of missing
#' values for all columns in `data` except `group`.
#'
...
#'                   By default, drops all levels of grouping (`"drop"`).
#'                   Specify `"keep"` to keep the output data frame grouped by
#'                   `group`. See `summarize()` documentation in `dplyr` for a
